...
var rawData = fs.readFileSync('/Users/zuic/Documents/azuic/data-structures/week10/M08CleanData.json');
...
async.eachSeries(m05, function(value, callback) {
    ...
    var thisQuery = "INSERT INTO aainfo ( address,mtgroup,lat,long, mtlocation, wheelchair ,mtdate, mtstart, mtend, mttype,mtspin,mtzone) VALUES (E'"+value.streetAddress+"','"+value.group + "',"+value.latitude+ ","+ value.longitude+ ",'"+ value.mtlocation+"','"+value.wheelchair+ "','{"+ value.day + "}','{" + value.start + "}','{"+ value.end +"}','{"+value.type+"}','{"+ value.spinterest+ "}',"+ value.zone+");";
